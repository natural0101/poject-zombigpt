...
| `catalog.py` | The published surface: 31 `ToolSpec`s and 7 `ResourceSpec`s, with bounds imported from the adapters that will receive them |
...
| `ports.py` | The seven `CoreServices` ports the boundary reads through |

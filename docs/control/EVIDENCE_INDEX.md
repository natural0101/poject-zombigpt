...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9261141201), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `a8cd1667093c31175d5375c0a7117cff9c584d563a0ac3bee79f133a1d6cc1df` |
| source commit | `81a55b97025ef06acc580e6bb96b3f4e1ca29cb5` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31936767248 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9359 of 9427 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9262374882), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `b94db5f0068cd314dc5a10036000dca7891fa410261dd6cf5f0d02436ca8f377` |
| source commit | `f6709ed3d6047b6ea8ab45e9c8e7488eb37b9e2a` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31941384490 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9376 of 9444 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9245187523), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `25e8b99d7896d9a6f0accbec036c95ca5a85bd37a38656a3ef014a51b51e2250` |
| source commit | `432d3d9c67d36e390b9904da14ae595232fbac02` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31876801440 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 8 check(s) passed` — archive complete, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 8666 of 8734 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

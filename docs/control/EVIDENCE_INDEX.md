...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9257008601), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `a797eee7364ea46d5c88f348b011ae8168012075fd5580c0bdde0bf98998aa5e` |
| source commit | `249b9e5f4bb10e687e7711d188e423bfc099dc0b` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31922264511 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9329 of 9397 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

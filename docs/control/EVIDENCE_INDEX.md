...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9262992417), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `e9c6ee2e1b19aa306f65851c8d95b5d2fb07d18c498ba42ec665276e0cfa7968` |
| source commit | `0081838677b02c543d248579ba05d8857140e327` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31943793560 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9388 of 9456 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

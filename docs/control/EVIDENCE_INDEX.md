...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9255430724), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `02bd678581b9cdf1c4413079cc30d0bde9b0aa37168da39227d9134576753d34` |
| source commit | `b61c3e7da64540528d1f40e5aa61c727e0550d47` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31916891786 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9321 of 9389 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

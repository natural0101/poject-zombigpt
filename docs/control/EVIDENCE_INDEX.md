...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9243915687), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `7ff65bbeb74d567983c9bbddf83436aeb7348339afba1095e0a2dd76ceff8fa1` |
| source commit | `496d59497610d034968053eb6e41c43aab49dbd7` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31871779877 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 8 check(s) passed` — archive complete, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 8598 of 8666 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

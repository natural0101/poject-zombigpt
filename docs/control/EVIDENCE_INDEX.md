...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9261651559), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `e409986b8e9e6564e31a25a6fc59d7f85ce5a253a2be78aa9f540efc6560eda9` |
| source commit | `5e71f23674351ee35df91a49e5142f8303120948` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31938586704 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9369 of 9437 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

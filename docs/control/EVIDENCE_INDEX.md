...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9256112646), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `e55dee4fb0773d8f431dc07f905dd4417faa12549b74f9ce83c56de7dbe12acb` |
| source commit | `bee43b5a7a811c57f8c4088fa574ec9793a4b9d3` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31919430269 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9326 of 9394 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

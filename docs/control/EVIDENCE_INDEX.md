...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9257493470), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `4682257af40d8d743c28f19d16b07f5135eaa7578d880e154f762711bc2a0f3c` |
| source commit | `5b67eb005d23bd080b87b5ed42aa50593f34a9e0` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31923903697 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 9341 of 9409 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |

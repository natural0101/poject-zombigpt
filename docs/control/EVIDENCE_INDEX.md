...
| Field | Value |
| --- | --- |
| archive | `pz-agent-windows-rc` (artifact 9247768043), `pz-agent-windows-v1.0.0-rc1.zip`, 77 entries |
| archive sha256 | `65a830fd216f712b65462f8092f3dad4585433f19d9355274d5609beef2874ff` |
| source commit | `a0edc089d0293d6e98a8134e5d9d99b458ac28e4` |
| workflow run | https://github.com/natural0101/poject-zombigpt/actions/runs/31886846831 |
| certified by | `check_release.py --rc` printing `CERTIFIED v1.0.0-rc1: 9 check(s) passed` — archive complete, the archive declaring the release this checkout builds, all 11 wrappers at the root, **both executables in `bin/`**, 76 file digests matching, 8682 of 8750 tests passed with no failures, 31 MCP end-to-end testcases green, and the archive claiming no live-test evidence. The packaged pair also completed an MCP `initialize` over the RPC link with `PATH` reduced to the system directories |
